...
function Step2() {
    ...
    return (
        <div className='text-black px-8'>
            ...
            <h2 className='text-2xl font-bold mb-5 flex items-center justify-start'><span className='flex-[1]'>Step 2: Sound the Alarm in India! Report the Credit Card Scam to Your Bank (No Time to Waste!)</span> <button onClick={(e) => (
                setActiveStep(null),
                completeSteps(2, 'cc')
