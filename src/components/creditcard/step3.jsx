...
function Step3() {
    ...
    return (
        <div className='text-black px-8'>
            ...
            <h1 className='text-2xl font-bold mb-5 flex items-center justify-start'><span className='flex-[1]'>Step 3: Fight Back! File a Cybercrime Report in India (Don&apos;t Let the Scammers Win)</span><button onClick={(e) => (
                setActiveStep(null),
                completeSteps(3, 'cc')
